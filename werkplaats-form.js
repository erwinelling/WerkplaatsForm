$(document).ready(function() {
     ...
     Alpaca.registerView({
          ...
          "fields": {
           ...
           "/handtekening-verzorger-a-naam":{
             "templates": {
               "control": "http://localhost/~erwinelling/Werkplaats/WerkplaatsForm/templates/control-text-signature-a.html"
             }
           },
           "/handtekening-verzorger-b-naam":{
             "templates": {
               "control": "http://localhost/~erwinelling/Werkplaats/WerkplaatsForm/templates/control-text-signature-b.html"
             }
           }
          },
          "messages": {
          ...
          "layout":{
           "template": "http://localhost/~erwinelling/Werkplaats/WerkplaatsForm/templates/werkplaats-layout.html",
           "bindings": {
    ...
    $("#form").alpaca({
        "data": data,
        "schema": "http://localhost/~erwinelling/Werkplaats/WerkplaatsForm/data/werkplaats-schema.json",
        "options": "http://localhost/~erwinelling/Werkplaats/WerkplaatsForm/data/werkplaats-options.json",
        "view": "werkplaats",
